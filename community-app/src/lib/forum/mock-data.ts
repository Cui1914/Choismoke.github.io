...
const baseMeta: ApiMeta = {
  requestId: "mock-forum-v2",
  generatedAt: "2026-03-21T12:00:00+08:00",
};
...
export const forumHomeMock: ForumHomePayload = {
  ...
  announcement: {
    title: "社区当前状态",
    body:
      "这一版前端预览已经按你定义的论坛规则组织完成：四个主分类、公开阅读、账号互动和可扩展的管理能力都已经体现在页面结构里。",
    tone: "important",
  },
  stats: [
    { value: "4", label: "主分类" },
  ...
  hotTopics: {
    ...
    items: [
      {
        id: "hot-long-term-showcase",
        title: "个人项目怎样展示，才更适合长期保留和持续更新？",
      },
      {
        id: "hot-replay-title",
        title: "如果现在要你立刻重玩一款单机游戏，你会选哪一个？",
      },
      {
        id: "hot-film-shot",
        title: "最近有没有哪个电影镜头，过了很久还留在你脑子里？",
      },
    ],
  },
  activeUsers: {
...
export const forumProfileMock: ForumProfilePayload = {
  ...
  recentThreads: {
    ...
    items: [
      {
        label: "做个人项目时，你会先保证功能闭环还是先打磨质感？",
        href: "/forum/thread",
      },
      {
        label: "个人项目里，有没有必要保留完整的复盘记录？",
        href: "/forum/thread",
      },
      {
        label: "哪些界面细节最能提升作品的完成度感受？",
        href: "/forum/thread",
      },
    ],
  },
...
export const threadDetailMock: ThreadDetailPayload = {
  ...
  tags: ["前端", "产品思考", "开发流程"],
  body: [
    "个人项目经常会同时面临两个方向的拉扯：一边是尽快把核心路径做通，另一边是希望页面和整体气质尽早达到可以展示的状态。",
    "我现在更倾向于先把最小可用闭环完成，再去补动画、排版、细节和整体完成度。但如果这个项目本身就是作品型项目，过于粗糙的呈现也可能直接削弱继续做下去的动力。",
    ...
    items: [
      {
        ...
        detail: "“我一般会先让一条核心路径可用，界面早期只要保证可读性就够了。”",
        time: "10 分钟前",
        unread: true,
      },
      {
...
export const messagesMock: MessagesPayload = {
  ...
  currentThread: {
    ...
    intro: "你们已经互相关注，因此当前会话不受“陌生人仅可先发 1 条消息”的限制。",
  },
  threads: {
    meta: baseMeta,
    items: [
  ...
  messages: {
    ...
    items: [
      ...
      },
      {
        ...
        author: "我",
        time: "今天 14:10",
        body: "我一般会留一个稳定的公开概述页，把实验性的过程和临时思路放进周记里，这样项目页本身会更清晰。",
      },
      {
        id: "mb3",
        sender: "other",
